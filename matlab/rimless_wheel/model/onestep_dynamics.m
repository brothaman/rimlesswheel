%===================================================================
function [z,t,thetadotmid,Avg_Velocity,error_flag]=onestep_dynamics(z0,parms,steps)
%===================================================================
...
%%% 9/28/2018
M11 = I1 + l^2*m1 + l^2*m2 - c*l*m2*cos(q1 - q2) - l*m2*w*sin(q1 - q2);
M21 = - l*cos(q1)*(c*cos(q2) - w*sin(q2)) - l*sin(q1)*(c*sin(q2) + w*cos(q2));
M12 = I2 - m2*((c*cos(q2) - w*sin(q2))*(l*cos(q1) - c*cos(q2) + w*sin(q2)) - (c*sin(q2) + w*cos(q2))*(c*sin(q2) + w*cos(q2) - l*sin(q1)));
M22 = I2 + c^2 + w^2;

RHS1 = I1*v1 + I2*v2 - m2*((v2*(c*cos(r2) - w*sin(r2)) - l*v1*cos(r1))*(l*cos(r1 + (2*pi)/n) - c*cos(r2) + w*sin(r2)) - (v2*(c*sin(r2) + w*cos(r2)) - l*v1*sin(r1))*(c*sin(r2) - l*sin(r1 + (2*pi)/n) + w*cos(r2))) + m1*(l^2*v1*cos(r1 + (2*pi)/n)*cos(r1) + l^2*v1*sin(r1 + (2*pi)/n)*sin(r1));
RHS2 = (c*cos(r2) - w*sin(r2))*(v2*(c*cos(r2) - w*sin(r2)) - l*v1*cos(r1)) + I2*v2 + (v2*(c*sin(r2) + w*cos(r2)) - l*v1*sin(r1))*(c*sin(r2) + w*cos(r2));
