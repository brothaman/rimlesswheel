%===================================================================
function animate_fixed(t_all,z_all,parms,steps,fps,farview)
%===================================================================
...
for i = 1:length(index)
   z_unique = [z_unique; z_all(index(i),1), parms.control.alpha, z_all(index(i),3),  z_all(index(i),4)];
end
...
window_ymin = -0.1; window_ymax = 2*max([parms.l,parms.L])+0.1;
if (farview == 1)
...
for i=1:m
   ...
   hinge=[xh; yh];    
        ...
        bar(:,:,parms.n+1) = [hinge,hinge] + L*R(A)*barref;
