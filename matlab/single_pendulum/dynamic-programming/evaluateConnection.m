function evaluateConnection(m,n,connection)
global NODES
...
if isempty(NODES{m,n}.optimal_value)
    NODES{m,n}.optimal_value = transition_cost + state_cost;
    NODES{m,n}.optimal_policy  = pol;
% otherwise check to see if there is a value in 
elseif NODES{m,n}.optimal_value > transition_cost + state_cost
    NODES{m,n}.optimal_value = transition_cost + state_cost;
    NODES{m,n}.optimal_policy  = pol;
end
end